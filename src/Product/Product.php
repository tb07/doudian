...
class Product extends BaseService
{
    ...
    : array
    {
        return $this->app->http->post('product/add', $params);
    }
     ...
     */
    public function addProductV2(array $params)
    : array
    {
        return $this->app->http->post('product/addV2', $params);
    }

    //运费模板查询 getFreightTemplateList()
    public function getFreightTemplateList(array $params)
    {
        return $this->app->http->post('freightTemplate/list', $params);
    }

    //删除商品 delProduct()
    public function delProduct(array $params)
    {
        return $this->app->http->post('product/del', $params);
    }

    //获取商品详情 getProduct()
    public function getProduct(array $params)
    {
        return $this->app->http->post('product/detail', $params);
    }

    //编辑商品 editProduct()
    public function editProduct(array $params)
    {
        return $this->app->http->post('product/edit', $params);
    }

    //编辑商品 editProductV2()
    public function editProductV2(array $params)
    {
        return $this->app->http->post('product/editV2', $params);
    }

    //编辑商品限购 setProductBuyerLimit()
    public function setProductBuyerLimit(array $params)
    {
        return $this->app->http->post('product/editBuyerLimit', $params);
    }

    //根据商品分类获取对应的属性列表 getPrdocutCateProperty()
    public function getPrdocutCateProperty(array $params)
    {
        return $this->app->http->post('product/getCateProperty', $params);
    }

    //获取商品列表 getProductList()
    public function getProductList(array $params)
    {
        return $this->app->http->post('product/list', $params);
    }
    ...
    {
        return $this->app->http->post('spec/add', $params);
    }

    //删除规格 delSpec()
    public function delSpec(array $params)
    {
        return $this->app->http->post('spec/del', $params);
    }

    //获取规格列表 getSpecList()
    public function getSpecList(array $params)
    {
        return $this->app->http->post('spec/list', $params);
    }

    //获取规格详情 getSpec()
    public function getSpec(array $params)
    {
        return $this->app->http->post('spec/specDetail', $params);
    }
}
